...
def main():
    ...
    doric = Object(color_shader, "doric", "../tests/doric/doric.obj", position = (0, -15, 15), scaling=(0.05, 0.05, 0.05))
    scene.add(doric)

    ionic = Object(color_shader, "ionic", "../tests/ionic/ionic.obj", position=(-10, 10, 0), scaling=(0.05, 0.05, 0.05))
    scene.add(ionic)
...
if __name__ == '__main__':
    ...
    # problème de texture sur la colonne mais pas le reste ? Il n'y a pas de lignes vt dans le fichier obj donc pas de uv_coords
